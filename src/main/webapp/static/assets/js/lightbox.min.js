...
function(a) {
	...
	b.prototype.build = function() {
		...
		$([this.$overlay[0],this.$lightbox[0]]).bind("mousewheel", function(e){
			...
			var layH = self.$overlay.height() * 20-20;
			var layW = self.$overlay.width() * 20 -20;
			// 向下
