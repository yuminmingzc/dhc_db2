		...
		<div class="widget-box widget-compact">
			...
			<div class="widget-body">
				<div class="widget-main no-padding">
					<form:form id="searchForm" modelAttribute="act" action="" method="get"
...
<script type="text/javascript">
	...
	var scripts = [null, '${ctxStatic}/assets/js/date-time/bootstrap-datepicker.js'
		, '${ctxStatic}/assets/js/date-time/bootstrap-datepicker.zh-CN.min.js', null];
	$('.page-content-area').ace_ajax('loadScripts', scripts, function () {
		jQuery(function ($) {
			...
			jQuery(grid_selector).jqGrid({
				...
				url: '${ctx}/task/historicTaskData', //这是数据的请求地址
				height: 'auto',
				autowidth: false,
				shrinkToFit: true,
				jsonReader: {
				...
				colNames: ['操作', '标题', '当前环节', '流程名称', '流程版本', '完成时间', 'task.id', 'task.assignee', '', '', '', '', '', 'status'],
				colModel: [
					...
					{name: 'taskEndTime', index: 'task.createTime'},
				...
				gridComplete: function () {
					...
					for (var i = 0; i < ids.length; i++) {
						...
						var view = '<a href="${ctxPage}/act/task/form?taskId=' + taskId
							+ '&taskName=' + taskNameEncode + '&taskDefKey=' + taskDefKey
							+ '&procInsId=' + procInsId
							+ '&procDefId=' + procDefId
							+ '&status=' + status + '">详情</a>';
...
//					delfunc: doDelete,
			...
			<%--function page(n, s) {--%>
			<%--location = '${ctxPage}/task/historicTask/?pageNo=' + n + '&pageSize=' + s;--%>
			<%--}--%>
