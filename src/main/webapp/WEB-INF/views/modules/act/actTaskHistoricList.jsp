		...
		<tbody>
			<c:forEach items="${page.list}" var="act">
				...
				<tr>
					...
					<td>
						<a target="_blank" href="${pageContext.request.contextPath}/act/rest/diagram-viewer?processDefinitionId=${task.processDefinitionId}&processInstanceId=${task.processInstanceId}&projectUrl=${pageContext.request.contextPath}">${task.name}</a><%--
