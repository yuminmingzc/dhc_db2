...
public class Act extends BaseEntity<Act> {
    ...
    private String varsMapTitle;// 流程变量MAP标题
...
//            return TimeUtils.toTimeString(histIns.getDurationInMillis());
            return TimeUtils.formatDuring(histIns.getEndTime().getTime()-histIns.getStartTime().getTime());
        }
        return "";
    }
    ...
    public String getVarsMapTitle() {
        return varsMapTitle;
    }

    public void setVarsMapTitle(String varsMapTitle) {
        this.varsMapTitle = varsMapTitle;
    }
