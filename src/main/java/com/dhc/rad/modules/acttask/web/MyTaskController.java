 ...
 */
package com.dhc.rad.modules.acttask.web;
...
//        }
        return "modules/acttask/todoList";
    }

    @RequestMapping(value = {"todoTaskData"})
    @ResponseBody
    public Map<String, Object> todoTaskData(Act act, HttpServletRequest request, HttpServletResponse response, Model model) {
...
//        returnMap.put("records", page.getCount());
     ...
     * @return
     */
    @RequestMapping(value = {"historicTask"})
    public String historicTaskList(Act act, HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {

        return "modules/acttask/historicList";
    }

    @RequestMapping(value = {"historicTaskData"})
    @ResponseBody
    public Map<String, Object> historicTaskData(Act act, HttpServletRequest request, HttpServletResponse response, Model model) {
        Map<String, Object> returnMap = new HashMap<String, Object>();
